...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | Crosery🥝")[0];
}
...
function createtime2() {
  ...
  setTimeout(
    console.log.bind(
      ...
      "",
      "",
      'background:url("https://luoxi2334.oss-cn-shanghai.aliyuncs.com/luoxi-picture/202410111812580.png") no-repeat;font-size:450%'
    )
  );
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by crosery🥝 %c 你正在访问crosery🥝のBolg",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Crosery🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Crosery🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://lskypro.acozycotage.net/Crosery/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://lskypro.acozycotage.net/Crosery/badge/F小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://luoxi2334.oss-cn-shanghai.aliyuncs.com/luoxi-picture/qq_pic_merged_1668848562052.jpg);
    --darkmode-bg:url(https://luoxi2334.oss-cn-shanghai.aliyuncs.com/luoxi-picture/202301222211019.jpg);
    --mobileday-bg: url(https://luoxi2334.oss-cn-shanghai.aliyuncs.com/luoxi-picture/qq_pic_merged_1668848562052.jpg);
    --mobilenight-bg: url(https://luoxi2334.oss-cn-shanghai.aliyuncs.com/luoxi-picture/202301222211019.jpg);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Crosery/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Crosery/img/home_bg.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Crosery/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Crosery/img/fj1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Crosery/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Crosery/img/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/Crosery/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/Crosery/img/mb4.webp)')"></a></div>
              </div>
            </details>
